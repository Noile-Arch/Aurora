  ...
  return (
    <div className="w-full h-full  px-4 md:px-10  lg:px-20">
      <div className="w-full h-full flex md:flex-row flex-col justify-around items-center gap-4">
        <div className="lg:w-[420px] w-full py-4  lg:h-[320px] h-auto bg-white shadow-xl rounded-2xl flex flex-col gap-2 justify-center items-center px-4">
        ...
        <div className="lg:w-[420px] w-full py-4 lg:h-[320px] bg-white shadow-xl rounded-2xl flex flex-col gap-2 justify-center items-center px-4">
          <p className="text-chocolate font-bold text-5xl">
            <RiDoubleQuotesL />
          </p>
          <p className="text-center font-semibold">
